            ...
            <div className="widget w-full overflow-hidden mb-5 p-4">
                ...
                <div className="widget w-full overflow-hidden mb-5 p-4">
                    <div className="flex mb-4 items-center">
                        ...
                        <input type="text" name='birthday' onChange={changeEvent} className='border text-sm p-2 rounded-md' />
                    </div>
                </div>
                <div className="widget w-full overflow-hidden mb-5 p-4">
                    <div className="flex mb-4 items-center">
                ...
                <div className="flex justify-end gap-x-5">
                    ...
                    <button onClick={submitEvent} className='bg-orange-500 text-white px-4 py-2 rounded shadow-md hover:bg-orange-600'>추가</button>
            </div>
        </>
    )
}